...
class Context:
    ...
    sub_model: Annotated[str, "用于执行每个任务的模型"] = "dashscope:qwen3-max-preview"
    write_model: Annotated[str, "用于执行记笔记任务的模型"] = "dashscope:qwen-flash"
    summary_model: Annotated[str, "用于执行总结任务的模型"] = "dashscope:qwen3-max-preview"
    report_model: Annotated[str, "用于生成报告模型的模型"] = "dashscope:qwen3-max-preview"
