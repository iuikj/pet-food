...
# 注册路由
from src.api.routes import auth, plans, tasks, verification, pets, meals, calendar, analysis, weights
...
app.include_router(weights.router, prefix="/api/v1/weights", tags=["体重记录"])
